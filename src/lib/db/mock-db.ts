...
const DEFAULT_GROUNDS: Ground[] = [
  { id: 'g1', name: 'Ground A (Premium Turf)', hourly_rate: 1200, created_at: new Date().toISOString() },
  { id: 'g2', name: 'Ground B (Standard Turf)', hourly_rate: 1000, created_at: new Date().toISOString() }
];
